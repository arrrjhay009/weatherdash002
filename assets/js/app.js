...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `
            <h2 class="title-2" id="highlight-label">Today's Highlights</h2>
        ...
        module.aqiText[aqi].message
                ...
                <div class="card card-sm highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-3">${humidity}<sub>%</sub></p>
                    </div>
                </div>
                ...
                <div class="card card-sm highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-3">${pressure}<sub>hPa</sub></p>
                    </div>
                </div>
                ...
                <div class="card card-sm highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-3">${visibility / 1000}<sub>km</sub></p>
                    </div>
                </div>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        windLi.innerHTML = `
                <div class="card card-sm slider-card">
                    ...
                    <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction" class="weather-icon" style="transform: rotate(${
                      windDirection - 180
                    }deg)">
